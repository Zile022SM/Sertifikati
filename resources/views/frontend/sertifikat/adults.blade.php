                ...
                <div class="col-xs-10 col-xs-offset-1 wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2  col-xs-4  wrap-lang">
                            <a href="{{route('odrasli',['jezik'=>'srpski','broj'=>$data->first()->certificate_number])}}"><div class="col-sm-3  col-sm-offset-3   col-xs-5   div-srb"> <img src="/templates/sertifikat/images/srb.jpg" class="img-responsive img-lang" title="SERBIAN" alt="zastava Srbija" > </div></a>
                            <a href="{{route('odrasli',['jezik'=>'engleski','broj'=>$data->first()->certificate_number])}}"><div class=" col-sm-3 col-xs-5  div-eng"> <img src="/templates/sertifikat/images/eng.jpg" class="img-responsive img-lang" title="ENGLISH" alt="zastava Engleska" > </div></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <!--ime i prezime-->
                        <div class="col-xs-12 text-center ime-prezime-wrap"><span class="imePrezime-change"> {{$data->first()->name}} {{$data->first()->surname}}</span> <a href="{{route('sertifikat-lista',['student'=>$data->first()->students_id,'jezik'=>$jezik,'broj'=>$data->first()->certificate_number])}}"  class="dugme-listaSertifikata">{{($jezik == 'engleski')?'Certificates list':'Lista sertifikata'}}</a> </div>
                        <!--broj-->
