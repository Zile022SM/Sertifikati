...
@section('seo-title') 
<title>Edit course {{ config('app.seo-separator')}}{{ config('app.name')}}</title>
@endsection 
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit course  {{$course->title_eng}}</h1>
    </div>   
    <!-- /.col-lg-12 -->
        ...
        <div class="col-lg-6">
            <form role="form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group{{$errors->has('duration_srp')?' has-error':''}}">
                    ...
                    <input class="form-control" name="duration_srp" value="{{old('duration_srp',$course->duration_srp)}}" type="text" placeholder="npr 30 casova">
                ...
                <div class="form-group{{$errors->has('duration_eng')?' has-error':''}}">
                    ...
                    <input class="form-control" name="duration_eng" value="{{old('duration_eng',$course->duration_eng)}}" type="text" placeholder="e.g. 30 classes">
                ...
                <div class="form-group{{$errors->has('title_srp')?' has-error':''}}">
                    ...
                    <input class="form-control" name="title_srp" value="{{old('title_srp',$course->title_srp)}}" type="text" placeholder="Enter title_srp">
                ...
                <div class="form-group{{$errors->has('title_eng')?' has-error':''}}">
                    ...
                    <input class="form-control" name="title_eng" value="{{old('title_eng',$course->title_eng)}}" type="text" placeholder="Enter title_eng">
                ...
                <div class="form-group{{$errors->has('class')?' has-error':''}}">
                    ...
                    <select class="form-control" name="class">
                        ...
                        <option value="children" {{(old('class',$course->class)=='children')?'selected':''}}>Children</option>
                        <option value="scratch" {{(old('class',$course->class)=='scratch')?'selected':''}}>Scratch</option>
                        <option value="adults" {{(old('class',$course->class)=='adults')?'selected':''}}>Adults</option>
                    </select>
                    @if($errors->has('class'))
                ...
                <div class="form-group{{$errors->has('description_srp')?' has-error':''}}">
                    ...
                    <textarea class="form-control" name="description_srp">{{old('description_srp',$course->description_srp)}}</textarea>
                ...
                <div class="form-group{{$errors->has('description_eng')?' has-error':''}}">
                    ...
                    <textarea class="form-control" name="description_eng">{{old('description_eng',$course->description_eng)}}</textarea>
                ...
                <div class="form-group text-right">
                    <button type="submit" class="btn btn-primary pull-right">Edit course</button>
                </div>
            </form>
        </div>
    </div>
