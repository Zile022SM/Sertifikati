...
<html class="no-js" lang="sr-rs">
    <head>
        <title>Postovi iz kategorije zanimljivosti | Admin</title>
        <!-- Meta Tags -->
        <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12  col-sm-12 text-center wow fadeInUp">
                        <!-- h1 -->
                        <h1 class="h1-custom margin-two post-h1">IT ZANIMLJIVOSTI ADMIN</h1>
                        <!-- end h1 -->
                    </div>
                </div>
            </div>
        </section>
        <div class="col-md-12  col-sm-12 text-center wow fadeInUp" id="navbarSupportedContent" style="text-align: center;">
                        ...
                        <div class="col-md-12 blog-details blog-details-zanimljivosti">
                            ...
                            <div class="text-center mojtip">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="{{route('facts-preview',['post'=>$post->id])}}" data-toggle="tooltip" data-placement="top" data-original-title="post preview"><i class="fa fa-search fa-2x" aria-hidden="true" style="color:green;margin: 0 10px 0 10px;"></i></a>
                                    @if($post->active == 1)
                                    <a href="{{route('facts-active',['base'=>$post->id])}}" data-toggle="tooltip" data-placement="top" data-original-title="hide post"><i class="fa fa-eye-slash fa-2x" aria-hidden="true" style="color:orangered;margin: 0 10px 0 10px;"></i></a>
                                    @else
                                    <a href="{{route('facts-active',['base'=>$post->id])}}" data-toggle="tooltip" data-placement="top" data-original-title="show post"><i class="fa fa-eye fa-2x" aria-hidden="true" style="color:green;margin: 0 10px 0 10px;"></i></a>
                                    @endif
                                    <a href="{{route('facts-edit',['post'=>$post->id,'currentPage'=>$postovi->currentPage()])}}" data-toggle="tooltip" data-placement="top" data-original-title="edit post"><i class="fa fa-pencil fa-2x" aria-hidden="true" style="color:green;margin: 0 10px 0 10px;"></i></a>
                                    <a data-href="{{route('facts-delete',['id'=>$post->id])}}" data-username="{{$post->seo_title}}" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash fa-2x" aria-hidden="true" style="color:red;margin: 0 10px 0 10px;"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
