...
@section('seo-title') 
<title>All teachers {{ config('app.seo-separator')}}{{ config('app.name')}}</title>
@endsection 
<!-- DataTables CSS -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="padding: 10px;"> 
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="students-table">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td style='text-align: center'><img src='{{$value->getImage('s')}}'></td>
                        ...
                        <td class="center mojtip" style="text-align: center">
                            <a data-toggle="tooltip" data-placement="top" data-original-title="edit teacher" class="btn btn-sm btn-success" href="{{route('teachers-edit',['teacher'=>$value->id])}}"><i class="fa fa-wrench"></i></a> 
                            <a data-button-title='Delete' data-placement="top" data-original-title="delete teacher {{$value->name}}" class="btn btn-sm btn-danger" data-href="{{route('teachers-delete',['teacher'=>$value->id])}}" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            <div class="alert alert-warning">
                Nema unetih profesora
                <a href="{{route('teachers-create')}}"> >> unesi profesora  <<</a>
            </div>
            @endif
        </div>
    </div>
