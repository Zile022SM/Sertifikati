...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Create knowledge base post </h1>
    </div>   
    <!-- /.col-lg-12 -->
        ...
        <div class="col-lg-6">
            <form role="form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group{{$errors->has('seo_title')?' has-error':''}}">
                    ...
                    <input class="form-control" name="seo_title" value="{{old('seo_title')}}" type="text" placeholder="Enter seo_title">
                ...
                <div class="form-group{{$errors->has('meta_description')?' has-error':''}}">
                    ...
                    <input class="form-control" name="meta_description" value="{{old('meta_description')}}" type="text" placeholder="Enter meta_description">
                ...
                <div class="form-group{{$errors->has('seo_title_h1')?' has-error':''}}">
                    ...
                    <input class="form-control" name="seo_title_h1" value="{{old('seo_title_h1')}}" type="text" placeholder="Enter seo_title_h1">
                ...
                <div class="form-group{{$errors->has('alt_attribute')?' has-error':''}}">
                    ...
                    <input class="form-control" name="alt_attribute" value="{{old('alt_attribute')}}" type="text" placeholder="Enter alt_attribute">
                ...
                <div class="form-group{{$errors->has('video')?' has-error':''}}">
                    ...
                    <input class="form-control" name="video" value="{{old('video')}}" type="text" placeholder="Enter youtube video link">
                    @if($errors->has('video'))
                ...
                <div class="form-group{{$errors->has('content')?' has-error':''}}">
                    ...
                    <textarea id="my-editor" class="form-control" name="content">{{old('content')}}</textarea>
