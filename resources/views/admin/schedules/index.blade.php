...
@section('seo-title') 
<title>Schedules {{ config('app.seo-separator')}}{{ config('app.name')}}</title>
@endsection 
<!-- DataTables CSS -->
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Course and teacher schedule </h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default" style="padding: 10px;"> 
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="students-table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center">Uzrast</th>
                        <th style="text-align: center">Pocetak / Kraj</th>
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td style="text-align: center">{{$value->title_eng}}</td>
                        <td style="text-align: center">{{$value->class}}</td>
                        <td style="text-align: center">{{$value->start_date}} / {{$value->end_date}}</td>
                        <td class="center mojtip" style="text-align: center">
                            <a data-toggle="tooltip" data-placement="top" data-original-title="edit c&t" class="btn btn-sm btn-success" href="{{route('schedules-edit',['schedule'=>$value->id])}}"><i class="fa fa-wrench"></i></a> 
                            <a data-button-title='Delete' data-placement="top" data-original-title="Delete c&t {{$value->title_eng}}" class="btn btn-sm btn-danger" data-href="{{route('schedules-delete',['schedule'=>$value->id])}}" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
            ...
            <div class="alert alert-warning">
                Nema unetih sertifikata
                <a href="{{route('schedules-create')}}"> >> unesi C&T  <<</a>
            </div>
            @endif
        </div>
    </div>
